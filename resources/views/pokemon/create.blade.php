        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('pokemons.store') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="sprite_url" class="block mt-1 w-full" type="text" name="sprite_url" :value="old('sprite_url')" required />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="weight" class="block mt-1 w-full" type="number" name="weight" :value="old('weight')" required min="1" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="height" class="block mt-1 w-full" type="number" name="height" :value="old('height')" required min="1" />
